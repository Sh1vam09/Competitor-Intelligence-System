...
from api.schemas import (
    ...
    CompanyResponse, CompetitorListResponse, CompetitorResponse,
)
...
app = FastAPI(
    ...
    description="AI-Powered Competitor Analysis API using Google Gemini",
    version="1.0.0",
)
...
def get_report_json(company_id: int, db: Session = Depends(get_db_dependency)):
    ...
    return {
        ...
        "pdf_available": bool(report.report_pdf_path and Path(report.report_pdf_path).exists()),
