...
from backend.utils.config import OPENROUTER_MAX_RETRIES
from backend.utils.helpers import safe_json_parse, retry_with_backoff, truncate_text
...
def extract_business_profile(
    ...
    return _call_llm_extraction(combined_text)


@retry_with_backoff(max_retries=OPENROUTER_MAX_RETRIES, base_delay=2.0)
def _call_llm_extraction(content: str) -> dict:
    """
